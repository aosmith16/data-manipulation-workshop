...
We can use `packageVersion` to check for the currently installed version of a package.  We should be using the current versions.
...
We will be using both categorical and continuous variables from this dataset, including:  `mpg` (Miles per US gallon),  
...
I didn't name the final object, but I should so I can use it in this problem.  I'll do that here, and print the result so I remember what it looked like.
